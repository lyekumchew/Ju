...
<div id="comments">
    ...
    <div id="<?php $this->respondId(); ?>" class="respond">
    	...
    	<form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
            ...
            <?php endif; ?>
              <div id="emoji"><?php Smilies_Plugin::output(); ?></div>
             
    		<p>
                <textarea rows="5" cols="50" name="text" id="textarea" class="textarea" required onkeydown="if(event.ctrlKey&&event.keyCode==13){document.getElementById('misubmit').click();return false};" ><?php $this->remember('text'); ?></textarea>
            </p>
